    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen p-8 space-y-6 text-gray-800 bg-gray-50">
            ...
            <section className="max-w-3xl space-y-4 text-left text-base">
                ...
                <p>
                    Individuals may request access, correction, or deletion of their data at any time by contacting us at <a href="mailto:sales@swissgpu.ch" className="underline">sales@gpu.swiss</a>.
                </p>
